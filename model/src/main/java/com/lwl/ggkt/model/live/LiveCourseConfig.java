...
public class LiveCourseConfig extends BaseEntity {
	...
	public boolean equals(Object o) {
		...
		LiveCourseConfig that = (LiveCourseConfig) o;
		return Objects.equals(getLiveCourseId(), that.getLiveCourseId()) && Objects.equals(getPageViewMode(), that.getPageViewMode()) && Objects.equals(getNumberEnable(), that.getNumberEnable()) && Objects.equals(getStoreEnable(), that.getStoreEnable()) && Objects.equals(getStoreType(), that.getStoreType());
	}

	@Override
	public int hashCode() {
		return Objects.hash(super.hashCode(), getLiveCourseId(), getPageViewMode(), getNumberEnable(), getStoreEnable(), getStoreType());
	}
}